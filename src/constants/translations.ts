...
export const TRANSLATIONS = {
  ru: {
    ...
    missingDimensions: "Изображение без размеров: У <img src=\"{src}\"> не заданы width/height или aspect-ratio.",
    missingLabel: "Отсутствует label: Поле ввода <{tag}> не имеет связанного тега <label> или aria-label. Критично для доступности (a11y).",
  ...
  en: {
    ...
    missingDimensions: "Image missing dimensions: <img src=\"{src}\"> is missing width/height attributes or aspect-ratio CSS property.",
    missingLabel: "Missing label: <{tag}> input has no associated <label> or aria-label. Critical for accessibility (a11y).",
